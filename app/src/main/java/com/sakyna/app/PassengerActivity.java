...
/*
 * IMPORTANT:
 * Logout signs out Firebase only.
 * It does NOT delete the Firebase account.
 *
 * The local Sakay Na session is completely cleared
 * so the next login starts as a fresh session.
 */
private void logout() {
    ...
    // DO NOT call currentUser.delete().
    auth.signOut();
    ...
    // Return to MainActivity and remove all previous
    // PassengerActivity screens from the back stack.
    Intent intent =
            new Intent(
