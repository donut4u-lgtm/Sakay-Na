...
public class DriverOnboardingActivity extends Activity {
    ...
    private void buildScreen() {
        ...
        locationTitle.setText("📍 Driver Location");
        locationTitle.setTextSize(20);
        locationTitle.setTypeface(null, android.graphics.Typeface.BOLD);
        locationTitle.setTextColor(Color.rgb(0, 100, 180));
        locationTitle.setPadding(0, 16, 0, 10);
        ...
        locationNote.setPadding(0, 0, 0, 16);
        ...
        vehicleTitle.setTypeface(null, android.graphics.Typeface.BOLD);
        vehicleTitle.setTextColor(Color.rgb(0, 130, 80));
        vehicleTitle.setPadding(0, 8, 0, 10);
